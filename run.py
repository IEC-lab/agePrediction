...
sys.path.insert(0, '/home/lc/caffe-drf/python')
import caffe
...
parser.add_argument('--gpu', type=int, required=False, default=4)
parser.add_argument('--data', type=str, required=False, default='Megaage')
...
#parser.add_argument('--model', type=str, required=False, default='./pre_model/SE-BN-Inception.caffemodel')
#parser.add_argument('--model', type=str, required=False, default='./pre_model/SE-ResNeXt-50.caffemodel')
parser.add_argument('--model', type=str, required=False, default='./best_model/new_VGG/Megaage_iter_66000.caffemodel')
#parser.add_argument('--model', type=str, required=False, default='./pre_model/VGG_ILSVRC_16_layers.caffemodel')
#parser.add_argument('--model', type=str, required=False, default='./pre_model/shufflenet_v2_x0.5.caffemodel')
parser.add_argument('--traintxt', type=str, required=False, default='./data/dushanzi_train.txt')
parser.add_argument('--testtxt', type=str, required=False, default='./data/dushanzi_test.txt')
args=parser.parse_args()

testdir = './data/dushanzi_256_256/'  #directory for test dataset
traindir = './data/dushanzi_256_256/' #directory for train dataset
...
def make_solver():
  ...
  s.test_interval = 2000 # will test mannualy
...
if __name__ == '__main__':
    ...
    sav_fn = join(tmp_dir, "MAE-%stree%ddepth%dtime%s"%(
